    ...
    <nav class="bg-gray-800/50">
      ...
      <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          ...
          <a href="/posts"
            class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Posts</a>
        </div>
        <!-- <div class="border-t border-white/10 pt-4 pb-3">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Mhammad Laravel</div>
              <div class="text-sm font-medium text-gray-400">mhammad@laracasts.com</div>
            </div>
            <button type="button"
